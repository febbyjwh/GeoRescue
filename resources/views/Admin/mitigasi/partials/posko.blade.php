    ...
    <div class="rounded-xl border border-gray-200 bg-white p-6">
        <form action="{{ route('posko.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                <x-form.form-elements.default-inputs label="Nama Desa" name="nama_desa" placeholder="Masukkan nama desa"
                    value="{{ old('nama_desa') }}" required />

                <x-form.form-elements.default-inputs label="Kecamatan" name="kecamatan"
                    placeholder="Masukkan nama kecamatan" value="{{ old('kecamatan') }}" required />
            </div>
