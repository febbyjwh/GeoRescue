<div class="relative" x-data="{
    ...
    >
                    ...
                    [
                        ...
                        'icon' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                fill-rule="evenodd"
                                clip-rule="evenodd"
                                d="M12 1a5 5 0 00-5 5v2H6a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V10a2 2 0 00-2-2h-1V6a5 5 0 00-5-5zm3 7V6a3 3 0 10-6 0v2h6zm-3 4a1 1 0 00-1 1v2a1 1 0 002 0v-2a1 1 0 00-1-1z"
                                fill="currentColor"
                            />
                        </svg>',
                        'path' => route('password.change.form'),
                    ],
                    [
                        'text' => 'Support',
                        'icon' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <form method="POST" action="{{ route('logout') }}">
            ...
            <button
                type="submit"
                class="flex items-center w-full gap-3 px-3 py-2 mt-3 font-medium text-gray-700 rounded-lg group text-theme-sm
